...
import { INodes } from "XmindTypes";
import * as controls from "../control";
import { ICurNode, IAddChildNodeInfo,
  actionSuccess, addChildNodeAction, deleteNodeAction, updateNodeAction, updateNodesAction } from "../actions";
...
export const addChildNodeEpic: RootEpic = (action$, store, { addNode }) =>
  action$.pipe(
    ...
    map((root: INodes) => actionSuccess(root))
  )
